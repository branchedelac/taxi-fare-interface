let taxiFareApiUrl = 'https://taxifare-ydlcssklqq-ew.a.run.app/predict'; // replace with your API endpoint
const centralCoordinates = [-74.00597, 40.71427]; // starting position [lng, lat]

if (window.location.href.includes('https://taxifare-ydlcssklqq-ew.a.run.app')) {
  taxiFareApiUrl = 'https://taxifare-ydlcssklqq-ew.a.run.app/predict';
}
